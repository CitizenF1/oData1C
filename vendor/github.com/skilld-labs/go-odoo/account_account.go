...
type AccountAccount struct {
	AccountTax    *String    `xmlrpc:"account_tax,omptempty"`
	ByDepartment  *Bool      `xmlrpc:"by_department,omptempty"`
	CashFlowType  *Many2One  `xmlrpc:"cash_flow_type,omptempty"`
	...
	Offbalance    *Bool      `xmlrpc:"offbalance,omptempty"`
	OpeningCredit *Float     `xmlrpc:"opening_credit,omptempty"`
	OpeningDebit  *Float     `xmlrpc:"opening_debit,omptempty"`
	Parent        *Many2One  `xmlrpc:"parent,omptempty"`
	Quantitative  *Bool      `xmlrpc:"quantitative,omptempty"`
	Reconcile     *Bool      `xmlrpc:"reconcile,omptempty"`
	RootId        *Many2One  `xmlrpc:"root_id,omptempty"`
	SubcontoLines *Relation  `xmlrpc:"subconto_lines,omptempty"`
	TagIds        *Relation  `xmlrpc:"tag_ids,omptempty"`
	Tax           *Bool      `xmlrpc:"tax,omptempty"`
